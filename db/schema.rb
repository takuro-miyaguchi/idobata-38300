...
ActiveRecord::Schema.define(version: 2022_09_22_074957) do
  ...
  create_table "favorites", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["information_id"], name: "index_favorites_on_information_id"
  ...
  add_foreign_key "favorites", "information"
